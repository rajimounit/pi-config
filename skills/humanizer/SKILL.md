...
6. **Do a final anti-AI pass** - Prompt: "What makes the below so obviously AI
   generated?" Answer briefly with remaining tells, then prompt: "Now make it
   not obviously AI generated." and revise
...
Replace curly/smart quotes ("...") with straight quotes ("...") for consistency.
...
Humans rarely hyphenate these uniformly. Less common or technical compound
...
With voice matching: "Humanize this text. Here's a sample of my writing for
voice matching: [sample]"

From file: "Humanize this text. Use my writing style from [file path] as a
reference."

If a writing sample is provided, analyze it before rewriting: read the sample
first, identify rhythm, word choices, and quirks, then apply them to the rewrite
instead of producing generic "clean" output.
...
Original: [blader/humanizer](https://github.com/blader/humanizer) v2.3.0
Curated by: [trailofbits/skills-curated](https://github.com/trailofbits/skills-curated)
